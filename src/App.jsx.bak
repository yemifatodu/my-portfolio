...
import { 
  ...
  Layers, Zap, Sparkles, ArrowRight, ExternalLink 
} from "lucide-react";
...
export default function PortfolioPreview() {
  ...
  const testimonials = [
    {
      quote: "Opeyemi demonstrated strong analytical thinking and consistently delivered actionable insights. His approach to modeling risk categories added profound statistical clarity to our operations.",
      author: "Project Supervisor",
      role: "MeriSkill Corporate Cohort",
      rating: 5
    },
    {
        ...
        <div className="min-h-screen bg-gradient-to-b from-white to-slate-100 dark:from-slate-950 dark:to-slate-900 text-slate-900 dark:text-white transition-colors duration-300">
          <main role="main">
            ...
            <header className="sticky top-0 z-50 bg-white/90 dark:bg-slate-950/90 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-800/50 transition-colors">
              <div className="max-w-7xl mx-auto flex justify-between items-center py-3 px-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="hidden sm:inline-flex text-xs px-2 py-0.5 rounded-full bg-indigo-100 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 font-medium border border-indigo-200 dark:border-indigo-800">
                ...
                <nav className="hidden md:flex items-center space-x-6">
                  ...
                  {['Home', 'About', 'Projects', 'Skills'].map(item => (
                    <a 
                      ...
                      className="hover:text-indigo-500 transition text-sm font-medium relative group"
                    >
                      {item}
                  ...
                  <a 
                    ...
                    className="text-indigo-400 hover:text-indigo-300 font-semibold transition text-sm flex items-center gap-1"
                  >
                    Huuboi.com <ExternalLink size={14} />
                  </a>
                  <div className="relative group">
                    <button className="hover:text-indigo-500 transition text-sm font-medium flex items-center gap-1">
                ...
                <div className="flex items-center gap-2 md:hidden">
                  ...
                  <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="p-2 hover:text-indigo-500 transition" aria-label="Toggle menu">
                ...
                >
                  {['Home', 'About', 'Projects', 'Skills'].map(item => (
                    <a 
                      key={item} 
                      href={`#${item.toLowerCase()}`} 
                      className="hover:text-indigo-500 transition text-sm font-medium py-1"
            ...
            <section className="max-w-5xl mx-auto py-12 px-6 text-center">
              ...
              >
                {[
                  ...
                  "EXPERIENCE IN Custom Data Pipelines & AI Products • Intelligent Analytics • Software Engineering",
                  "Building AI-powered software that transforms data into intelligent business solutions."
                ].map(tag => (
              ...
              >
                <a href="#projects" className="px-5 py-2 rounded-xl text-sm font-semibold text-white bg-indigo-600 shadow-lg shadow-indigo-600/30 hover:bg-indigo-500 hover:-translate-y-0.5 transition duration-200">
                  View Projects
                </a>
              ...
              <Card className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800/80 rounded-2xl overflow-hidden shadow-sm">
                <CardContent className="p-6 md:p-8 text-slate-600 dark:text-slate-300 leading-relaxed space-y-4">
                  ...
                  <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-800">
                    <button onClick={() => setExpandedAbout(!expandedAbout)} className="text-indigo-500 dark:text-indigo-400 font-semibold hover:underline text-sm flex items-center gap-2">
            ...
            <section id="skills" className="max-w-5xl mx-auto py-16 px-6">
              <h2 className="text-3xl font-bold mb-2 tracking-tight">Technology Stack</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-6 shadow-sm hover:shadow-md transition md:col-span-1">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="p-2 bg-cyan-100 dark:bg-cyan-950/50 rounded-xl">
            ...
            <section id="certifications" className="max-w-5xl mx-auto py-16 text-center px-6">
              <h2 className="text-3xl font-bold mb-4 tracking-tight">Education & Certifications</h2>
